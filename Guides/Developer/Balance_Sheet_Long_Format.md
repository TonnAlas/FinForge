...
## Migration Script
Temporary script:
- Temporary/migrate_balance_sheet_long_format.py

Purpose:
- Converts existing wide balance sheet files to long format.
...
```
python Temporary/migrate_balance_sheet_long_format.py
```

Then run the Balance Sheet import in Excel as usual.
