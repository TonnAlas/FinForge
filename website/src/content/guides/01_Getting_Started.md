...
order: 1
description: Installation, first launch, and system requirements.
---
...
- [Ticker Management](../02-ticker-management/) - Add and manage stock tickers
- [Importing Data](../03-importing-data/) - Import financial statements to Excel
- [Creating Ratios](../04-creating-ratios/) - Build custom financial ratios
- [Assigning Ratios](../05-assigning-ratios/) - Display ratios in Excel
...
- Review [Available Data Reference](../08-available-data-reference/) for all available data fields
- Check [Color Reference](../09-color-reference/) for the app's color scheme
