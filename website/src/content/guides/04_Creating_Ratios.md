---
title: Creating Ratios
order: 4
description: Build custom financial ratios.
---
...
**Solution:** See [Available Data Reference](../08-available-data-reference/) for valid field names
...
- [Assign them to Excel columns](../05-assigning-ratios/)
- [View in the Ratios sheet](../05-assigning-ratios/)
