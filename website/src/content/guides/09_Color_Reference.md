...
order: 9
description: Syntax highlighting color reference.
---
...
- Income Statement (green) vs Balance Sheet (blue): Can still distinguish by Blue vs non-Blue
- Operators (orange) vs Errors (red): Both may look similar, but errors have **wavy underline**
...
- Functions (yellow) vs Brackets (yellow): Both same color, but context differs
- Numbers (blue) vs Balance Sheet (blue): Both same color family, but context differs
...
4. **Advanced Functions Button** - Yellow-orange
